...
<div class="header" style="padding: 0;">
	<h2 style="color: white; width: 500px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">学生成绩管理系统</h2>
</div>
...
<div class="footer">Copyright@所有权&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://cs.hbpu.edu.cn/" target="_blank">
		湖北理工学院计算机学院&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
		 <a href="https://user.qzone.qq.com/3196614820/infocenter" target="_blank">陈&nbsp;&nbsp;&nbsp;政 </a>  </div>
</body>
</html>